...
public class ButtonDrawerAttribute : PropertyAttribute
{
    ...
    public ButtonDrawerAttribute(string MethodName)
    {
...
#if UNITY_EDITOR
[CustomPropertyDrawer(typeof(ButtonDrawerAttribute))]
public class InspectorButtonPropertyDrawer : PropertyDrawer
{
    ...
    {
        ButtonDrawerAttribute inspectorButtonAttribute = (ButtonDrawerAttribute)attribute;
